...
const resend = new Resend('re_2P975aWy_fudtY517ekBF38iqndVxVF8X');

export const sendOnboardingEmail = async (toEmail, username, taskTitle, taskCategory, reminderDate) => {
  try {
